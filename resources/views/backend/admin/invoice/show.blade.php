    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">Show Invoice</h2>
                        ...
                        <div class="card-body invoice-padding pt-0">
                            <div class="row invoice-spacing">
                                <div class="col-xl-8 p-0">
                                    ...
                                    <h6 class="mb-25">{{ $invoice->user_details['name'] }}</h6>
                                    <p class="card-text mb-25">{{ $invoice->user_details['email'] }}</p>
                                    <p class="card-text mb-25">{{ $invoice->user_details['phone_number'] }}</p>
                                </div>
                                ...
                                <div class="col-md-6 d-flex justify-content-end order-md-2 order-1">
                                    <div class="invoice-total-wrapper">
                                        <div class="invoice-total-item">
                                            ...
                                            <p class="invoice-total-amount">Rs. {{ $invoice->order_details['amount'] }}</p>
                                        </div>
                                    @if ($invoice->order_details['discount_amount'])
                                        <div class="invoice-total-item">
                                            <p class="invoice-total-title">Discount:</p>
                                            <p class="invoice-total-amount">- Rs. {{ $invoice->order_details['discount_amount'] }}</p>
                                        </div>
                                    @endif
                                        <div class="invoice-total-item">
                                            <p class="invoice-total-title">Tax ({{ $invoice->order_details['tax_percentage'] }}%):</p>
                                            <p class="invoice-total-amount">Rs. {{ $invoice->order_details['tax_amount'] }}</p>
                                        </div>
                                        <hr class="my-50" />
                                        <div class="invoice-total-item">
                                            <p class="invoice-total-title">Total:</p>
                                            <p class="invoice-total-amount">Rs. {{ $invoice->total_amount }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
