            ...
            <div class="mainContent">
                ...
                <div id='tab5' class='content'>
                    <div class="profileContent family">
                        ...
                        <div class="contentInfo">
                        @foreach(request()->user()->taken_tests as $userTest)
                            <div class="orderDetail">
                                <div class="orderCard">
                                ...
                                @if ($userTest->is_submitted)
                                    <p class="new">
                                        <a href="{{ route('take.test.result', [$userTest->course->slug, encrypt($userTest->id)]) }}">
                                ...
                                @else
                                    <p class="new">
                                        <a href="{{ route('take.test.show', [$userTest->course->slug, encrypt($userTest->id)]) }}">Attempt</a>
                                    </p>
                                @endif
                                </div>
                            </div>
