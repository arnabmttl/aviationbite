<div class="displayBar">
    <div class="quesCount">
        <span style="color: #333;">Q@{{ (questions.indexOf(selectedQuestion)+1) }}/{{ $userTest->questions->count() }} <i class="fas fa-thumbtack" v-on:click="markForReview()"></i></span>
    </div>
    <div>
    ...
    <div class="time">
        ...
        <span v-else>
            <i class="far fa-clock"></i> @{{ timeLeft | prettify }}
        </span>
    </div>
    <a
